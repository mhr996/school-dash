                    ...
                    <tbody>
                        {order.items.map((item, index) => (
                            <tr key={index} className="hover:bg-gray-50">
                                ...
                                <td className="border border-gray-300 px-4 py-3 text-right">₪{item.price.toFixed(0)}</td>
                                <td className="border border-gray-300 px-4 py-3 text-right font-semibold">₪{(item.price * item.quantity).toFixed(0)}</td>
                            </tr>
                        ))}
                    </tbody>
                </table>
                    ...
                    <div className="bg-gray-50 p-4 rounded">
                        ...
                        <div className="border-t border-gray-300 pt-2">
                            <div className="flex justify-between">
                                ...
                                <span className="text-lg font-bold text-green-600">₪{calculateTotal().toFixed(0)}</span>
                            </div>
                        </div>
                    </div>
                </div>
