        ...
        <div className="panel border-white-light px-0 dark:border-[#1b2e4b]">
            ...
            <div className="mb-5 flex flex-col gap-5 px-5 md:items-start">
                <div className="flex items-center gap-2">
                    ...
                    <h2 className="text-xl font-bold dark:text-white">{t('edit_security_company')}</h2>
                </div>
            ...
            <div className="px-5 pb-5">
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="flex justify-end gap-4">
                        <Link href={`/security-companies/preview/${companyId}`} className="btn btn-outline-danger">
                            {t('cancel')}
                        </Link>
