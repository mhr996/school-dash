        ...
        <div className="space-y-6">
            ...
            <div className="flex items-center justify-between">
                ...
                <div className="flex gap-3">
                    ...
                    <Link href="/destinations" className="btn btn-outline-secondary gap-2">
                        ...
                        <div className="panel">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                {item.properties!.map((kv, idx) => (
                                    ...
                                    >
                                        <div className="text-sm font-medium text-primary mb-1">{kv.label}</div>
                                        <div className="font-semibold text-gray-900 dark:text-white">{kv.value}</div>
                                    </div>
                                ))}
                            </div>
                        </div>
                        ...
                        <div className="panel">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                {item.requirements!.map((kv, idx) => (
                                    ...
                                    >
                                        <div className="text-sm font-medium text-orange-600 dark:text-orange-400 mb-1">{kv.label}</div>
                                        <div className="font-semibold text-gray-900 dark:text-white">{kv.value}</div>
                                    </div>
                                ))}
                            </div>
